...
- default_* is gone.  Use new_* instead.
  ...
  will need to change to validates_presence_of :association
- Cyclic dependencies can now be handled by checking the hash passed to the builders:
...
If you would like to change how this software works, please submit a patch with specs through
the lighthouse project page:

http://fixture_replacement.lighthouseapp.com/
