...
module FixtureReplacementController
  describe MethodGenerator, "Evaluation loading" do
    before :each do
      ...
      @item_attributes = Attributes.new(:item, :attributes => item_attributes)
      @writing_attributes = Attributes.new(:writing, :from => :item, :attributes => writing_attributes, :class => Writing)
