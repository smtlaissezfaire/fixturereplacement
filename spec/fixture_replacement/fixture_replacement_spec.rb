...
describe "FixtureReplacementGenerator.generate_methods" do
  before :each do
    @module = mock(FixtureReplacement)
    @module.stub!(:instance_methods).and_return ["user_attributes", "item_attributes", "some_other_method"]
    
    @generator = mock(FixtureReplacementGenerator)
    FixtureReplacementGenerator.stub!(:new).and_return @generator
  ...
  it "should respond to the method" do
    FixtureReplacementGenerator.should respond_to(:generate_methods)
  end
