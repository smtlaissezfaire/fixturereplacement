...
describe "FixtureReplacementController.defaults_file" do
  before :each do
    remove_constant(:RAILS_ROOT)
    @rails_root = "script/../config/../config/.."
    Object.send(:const_set, :RAILS_ROOT, @rails_root)
    FixtureReplacementController.instance_variable_set("@defaults_file", nil)
  end
  ...
  it "should be foo.rb if set" do
    FixtureReplacementController.defaults_file = "foo.rb"
    FixtureReplacementController.defaults_file.should == "foo.rb"
  end
end
